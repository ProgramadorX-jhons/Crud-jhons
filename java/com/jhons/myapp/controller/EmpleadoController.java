...
public class EmpleadoController {
    ...
    public List<Empleado> obtenerTodos(){
        return empleadoService.obtenerClientes();
    }
    ...
    public void guardarCliente(Empleado empleado){
        empleadoService.guardarCliente(empleado);
    }
    ...
    public void actualizarEmpleado(@PathVariable Long id, @RequestBody Empleado empleado){
        ...
        if(empleadoActual != null){
            ...
            empleadoService.actualizarCliente(empleadoActual);
        }
    }

    @DeleteMapping("/{id}")
    public void eliminarEmpleado(@PathVariable Long id){
        empleadoService.eliminarCliente(id);
    }
